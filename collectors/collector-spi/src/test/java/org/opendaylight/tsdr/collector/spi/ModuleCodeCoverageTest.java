...
import org.opendaylight.controller.config.yang.config.tsdr.collector.spi.AbstractTSDRCollectorSPIModuleFactory;
import org.opendaylight.controller.config.yang.config.tsdr.collector.spi.TSDRCollectorSPIModule;
...
public class ModuleCodeCoverageTest {
    ...
    public void codeCoverageModule(){
        new TSDRCollectorSPIModule(null,null,null,null);
        TSDRCollectorSPIModule module1 = new TSDRCollectorSPIModule(null,null);
        TSDRCollectorSPIModule module2 = new TSDRCollectorSPIModule(null,null);
        TSDRCollectorSPIModule module3 = new TSDRCollectorSPIModule(null,null);
        ...
        module1.equals(new TSDRCollectorSPIModule(null,null));
        ...
        AbstractTSDRCollectorSPIModuleFactory factory = new AbstractTSDRCollectorSPIModuleFactory() {
            @Override
            ...
            @Override
            public TSDRCollectorSPIModule instantiateModule(String instanceName, DependencyResolver dependencyResolver, TSDRCollectorSPIModule oldModule, AutoCloseable oldInstance, BundleContext bundleContext) {
                return super.instantiateModule(instanceName, dependencyResolver, oldModule, oldInstance, bundleContext);
            }

            @Override
            public TSDRCollectorSPIModule instantiateModule(String instanceName, DependencyResolver dependencyResolver, BundleContext bundleContext) {
                return super.instantiateModule(instanceName, dependencyResolver, bundleContext);
            }

            @Override
            public TSDRCollectorSPIModule handleChangedClass(DynamicMBeanWithInstance old) throws Exception {
                return super.handleChangedClass(old);
            }

            @Override
            public Set<TSDRCollectorSPIModule> getDefaultModules(DependencyResolverFactory dependencyResolverFactory, BundleContext bundleContext) {
