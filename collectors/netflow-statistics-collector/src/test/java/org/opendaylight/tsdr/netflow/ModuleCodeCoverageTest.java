...
import org.opendaylight.controller.config.yang.config.tsdr.netflow.statistics.collector.AbstractTSDRNetFlowCollectorModuleFactory;
import org.opendaylight.controller.config.yang.config.tsdr.netflow.statistics.collector.TSDRNetFlowCollectorModule;
import org.opendaylight.controller.config.yang.config.tsdr.netflow.statistics.collector.TSDRNetFlowCollectorModuleFactory;
...
public class ModuleCodeCoverageTest {
    ...
    public void codeCoverageModule(){
        TSDRNetFlowCollectorModuleFactory mf = new TSDRNetFlowCollectorModuleFactory();
        new TSDRNetFlowCollectorModule(null,null,null,null);
        TSDRNetFlowCollectorModule module1 = new TSDRNetFlowCollectorModule(null,null);
        TSDRNetFlowCollectorModule module2 = new TSDRNetFlowCollectorModule(null,null);
        TSDRNetFlowCollectorModule module3 = new TSDRNetFlowCollectorModule(null,null);
        ...
        module1.equals(new TSDRNetFlowCollectorModule(null,null));
        ...
        AbstractTSDRNetFlowCollectorModuleFactory factory = new AbstractTSDRNetFlowCollectorModuleFactory() {
            @Override
            ...
            @Override
            public TSDRNetFlowCollectorModule instantiateModule(String instanceName, DependencyResolver dependencyResolver, TSDRNetFlowCollectorModule oldModule, AutoCloseable oldInstance, BundleContext bundleContext) {
                return super.instantiateModule(instanceName, dependencyResolver, oldModule, oldInstance, bundleContext);
            }

            @Override
            public TSDRNetFlowCollectorModule instantiateModule(String instanceName, DependencyResolver dependencyResolver, BundleContext bundleContext) {
                return super.instantiateModule(instanceName, dependencyResolver, bundleContext);
            }

            @Override
            public TSDRNetFlowCollectorModule handleChangedClass(DynamicMBeanWithInstance old) throws Exception {
                return super.handleChangedClass(old);
            }

            @Override
            public Set<TSDRNetFlowCollectorModule> getDefaultModules(DependencyResolverFactory dependencyResolverFactory, BundleContext bundleContext) {
