...
import org.opendaylight.controller.config.yang.config.tsdr.controller.metrics.collector.AbstractTSDRCMCModuleFactory;
import org.opendaylight.controller.config.yang.config.tsdr.controller.metrics.collector.TSDRCMCModule;
import org.opendaylight.controller.config.yang.config.tsdr.controller.metrics.collector.TSDRCMCModuleFactory;
...
public class ModuleCodeCoverageTest {
    ...
    public void codeCoverageModule(){
        TSDRCMCModuleFactory mf = new TSDRCMCModuleFactory();
        new TSDRCMCModule(null,null,null,null);
        TSDRCMCModule module1 = new TSDRCMCModule(null,null);
        TSDRCMCModule module2 = new TSDRCMCModule(null,null);
        TSDRCMCModule module3 = new TSDRCMCModule(null,null);
        ...
        module1.equals(new TSDRCMCModule(null,null));
        ...
        AbstractTSDRCMCModuleFactory factory = new AbstractTSDRCMCModuleFactory() {
            @Override
            ...
            @Override
            public TSDRCMCModule instantiateModule(String instanceName, DependencyResolver dependencyResolver, TSDRCMCModule oldModule, AutoCloseable oldInstance, BundleContext bundleContext) {
                return super.instantiateModule(instanceName, dependencyResolver, oldModule, oldInstance, bundleContext);
            }

            @Override
            public TSDRCMCModule instantiateModule(String instanceName, DependencyResolver dependencyResolver, BundleContext bundleContext) {
                return super.instantiateModule(instanceName, dependencyResolver, bundleContext);
            }

            @Override
            public TSDRCMCModule handleChangedClass(DynamicMBeanWithInstance old) throws Exception {
                return super.handleChangedClass(old);
            }

            @Override
            public Set<TSDRCMCModule> getDefaultModules(DependencyResolverFactory dependencyResolverFactory, BundleContext bundleContext) {
