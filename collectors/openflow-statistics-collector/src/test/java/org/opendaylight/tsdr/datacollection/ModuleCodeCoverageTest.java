...
import org.opendaylight.controller.config.yang.config.tsdr.openflow.statistics.collector.AbstractTSDROSCModuleFactory;
import org.opendaylight.controller.config.yang.config.tsdr.openflow.statistics.collector.TSDROSCModule;
import org.opendaylight.controller.config.yang.config.tsdr.openflow.statistics.collector.TSDROSCModuleFactory;
...
public class ModuleCodeCoverageTest {
    ...
    public void codeCoverageModule(){
        TSDROSCModuleFactory mf = new TSDROSCModuleFactory();
        new TSDROSCModule(null,null,null,null);
        TSDROSCModule module1 = new TSDROSCModule(null,null);
        TSDROSCModule module2 = new TSDROSCModule(null,null);
        TSDROSCModule module3 = new TSDROSCModule(null,null);
        ...
        module1.equals(new TSDROSCModule(null,null));
        ...
        AbstractTSDROSCModuleFactory factory = new AbstractTSDROSCModuleFactory() {
            @Override
            ...
            @Override
            public TSDROSCModule instantiateModule(String instanceName, DependencyResolver dependencyResolver, TSDROSCModule oldModule, AutoCloseable oldInstance, BundleContext bundleContext) {
                return super.instantiateModule(instanceName, dependencyResolver, oldModule, oldInstance, bundleContext);
            }

            @Override
            public TSDROSCModule instantiateModule(String instanceName, DependencyResolver dependencyResolver, BundleContext bundleContext) {
                return super.instantiateModule(instanceName, dependencyResolver, bundleContext);
            }

            @Override
            public TSDROSCModule handleChangedClass(DynamicMBeanWithInstance old) throws Exception {
                return super.handleChangedClass(old);
            }

            @Override
            public Set<TSDROSCModule> getDefaultModules(DependencyResolverFactory dependencyResolverFactory, BundleContext bundleContext) {
