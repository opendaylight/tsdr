...
import org.opendaylight.controller.config.yang.config.TSDR_datastorage.impl.TSDRDatastorageModule;
import org.opendaylight.controller.config.yang.config.TSDR_datastorage.impl.TSDRDatastorageModuleFactory;
...
public class ModuleCodeCoverageTest {
    ...
    public void codeCoverageModule(){
        TSDRDatastorageModuleFactory mf = new TSDRDatastorageModuleFactory();
        new TSDRDatastorageModule(null,null,null,null);
        TSDRDatastorageModule module1 = new TSDRDatastorageModule(null,null);
        TSDRDatastorageModule module2 = new TSDRDatastorageModule(null,null);
        TSDRDatastorageModule module3 = new TSDRDatastorageModule(null,null);
        ...
        module1.equals(new TSDRDatastorageModule(null,null));
        ...
        AbstractTSDRDatastorageModuleFactory factory = new AbstractTSDRDatastorageModuleFactory() {
            @Override
            ...
            @Override
            public TSDRDatastorageModule handleChangedClass(DynamicMBeanWithInstance old) throws Exception {
                return super.handleChangedClass(old);
            }

            @Override
            public Set<TSDRDatastorageModule> getDefaultModules(DependencyResolverFactory dependencyResolverFactory, BundleContext bundleContext) {
